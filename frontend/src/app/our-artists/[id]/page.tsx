...
export default function ArtistDetailPage() {
  ...
  const getImageClassName = (imageUrl: string, isProfile = false) => {
    ...
    if (isProfile) {
      return `${baseClasses} ${transitionClasses} shadow-[0_0_35px_rgba(255,255,255,0.8)] ${
    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative bg-black/70 min-h-screen">
        <div className="p-4 md:p-8 max-w-7xl mx-auto">
          ...
          <FadeInOnScroll>
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-12 lg:gap-20 min-h-[60vh] mb-6">
